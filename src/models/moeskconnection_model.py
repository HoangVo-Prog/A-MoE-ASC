...
from src.models.moe import SeqMoELogits, SeqMoELogitsConfig
...
class MoESkConnection(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # MoE for residual/delta logits
        moe_cfg = SeqMoELogitsConfig(
            in_dim=in_dim,
        ...
        self.moe_residual = SeqMoELogits(moe_cfg)
